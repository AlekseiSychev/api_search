...
def nettest():
    with console2.status("[cyan]Ожидайте, идёт самотестирование сети..."):
        ...
        try:
            ...
            console2.print("[bold red]Нет сети\n\nВыход")
            sys.exit('Bad nettest. Нет сети')
...
# Скорость загрузки.
        try:
            ...
            d = "Download: [bold red]Сбой[/bold red]"
...
# Скорость выгрузки.
        try:
            ...
            u = "Upload: [bold red]Сбой[/bold red]"
# Ping.
        try:
